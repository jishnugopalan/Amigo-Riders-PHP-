			...
			<div class="sap_tabs">	
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
					<ul>
						...
						<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Update Your Password &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span></li>
					...
					<div class="agile-tb">
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<form action="forgot2.php" method="post" name="form1">				
								<!--input placeholder="Name" name="name" type="text" required=""-->
								<input placeholder="Write a new password" name="password"  type="text" required="" autocomplete="off">				
								<input placeholder="Re-write the above password" name="conpassword" type="text" required="" autocomplete="off">						
