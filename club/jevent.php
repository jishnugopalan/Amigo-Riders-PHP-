...
function getResult(tid) {
  ...
  xhttp.open("GET", "getJevent.php?q="+tid, true);
  xhttp.send();
}
	...
	<div class="banner">
		...
		<div class="container">
			...
			<div class="wthree-top-grid">
				...
				<h2>The Members joined on my events</h2>
			</div>
			<!-- //wthree-top-grid -->
		</div>
	</div>
...
<br><br><br><br>
			<center>
				<?php
				$sql="SELECT * FROM event where email='$id'";
$result=mysqli_query($conn,$sql);
?>
<label>Select an event</label>
				 <select name="ename" id="country-list" class="form-control" onChange="getResult(this.value);">
