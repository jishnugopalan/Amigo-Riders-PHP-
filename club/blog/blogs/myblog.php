            ...
            <aside class="sidemenu font-14 col-md-6">
                ...
                <div class="widget">
                    ...
                    <ul class="nav-list bold-subtitle">
                        <?php
                                         $sql4="SELECT * FROM comment a,club_reg b where sell_id='$bid'and a.email=b.email and ctype='blog'";
...
<section class="py bg-gray2 border-1 border-gray2">
    ...
    <div class="custom-slider container block-img circle-dots dark-dots c-grab gray7" data-slick='{"dots": true, "fade": false, "draggable":true, "slidesToShow": 3, "slidesToScroll": 2}'>
        ...
        <div class="xxs-px sm-py">
            <a href="..\manaliToSrinagar.html" class="relative">
                <div class="block-img o-hidden"><img src="" alt="" class="scale-hover"></div>
                <div class="xs-px xs-py bg-white bs-light">
                    <h4 class="bold-subtitle dark mini-mt">Ladakh Bike Tour - June 2019</h4>
                    <h5 class="bold-subtitle dark mini-mt"></h5>
                    <!-- Post Message -->
                    <p class="mini-mt">
                                            </p>
                </div>
        ...
        <!-- Post -->
        <div class="xxs-px sm-py">
            <a href="..\spiti.html" class="relative">
                <div class="block-img o-hidden"><img src="" alt="" class="scale-hover"></div>
                <div class="xs-px xs-py bg-white bs-light">
                    <h4 class="bold-subtitle dark mini-mt">Spiti Valley Bike Tour</h4>
                    <h5 class="bold-subtitle dark mini-mt"></h5>
                    <!-- Post Message -->
                    <p class="mini-mt">
                                            </p>
        ...
        <!-- Post -->
        <div class="xxs-px sm-py">
            <a href="..\northEastWander.html" class="relative">
                <div class="block-img o-hidden"><img src="" alt="" class="scale-hover"></div>
                <div class="xs-px xs-py bg-white bs-light">
                    <h4 class="bold-subtitle dark mini-mt">North East India Bike Tour</h4>
                    <h5 class="bold-subtitle dark mini-mt"></h5>
                    <!-- Post Message -->
                    <p class="mini-mt">
                                            </p>
