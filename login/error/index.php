...
<html>
<head>
	<title>Flat Error Page a Flat Responsive Widget Template :: w3layouts</title>
		...
		<div class="agile">
			...
			<div class="w3l">
				<div class="text">
					...
					<p>You have been tricked into click on a link that can not be found. Please check the url or go to<?php echo "<a href='../index.php'>Main page</a>"; ?>	 and see if you can locate what you are looking for</p>
				</div>
				<div class="image">
				...
				<div class="footer">
					<p>&copy; 2016 Amigo Riders. All Rights Reserved | Design by <a href="http://w3layouts.com">amigoriders</a></p>
				</div>
				<!-- <div class="wthree">
					<div class="back">
						echo "<a href='../../login/web/index.html'>Back to home</a>"; ?>
					</div>
