		...
		<!-- menu -->
			...
			<div id="m_nav_container" class="m_nav">
			  <ul id="m_nav_list" class="m_nav">
				...
				<?php 
				// echo "<li><br><a href='../blog/web/index1.php'>Blog</a><br></li>";
				  ...
				  echo "<li><a href='../../../Trip Create Form/web/index.html'>Trip Create</a><br></li>";
...
if($query->num_rows > 0){
    while($row = $query->fetch_assoc()){
       ...
       <font color="black">	<h2>                
    <img class="p" src="<?php echo $imageURL; ?>" alt="" width="300" height="300"/>
				<!--div class="col-md-4 w3l-welcome-left"-->
				 &nbsp <?php echo $name ?><br>
					<?php echo $place ?>,<?php echo $state ?></h2>
				</font>
			</div>
		</div>
...
<h1 id="c2"></h1>
<h1>
	<a href=<?php echo "'../../../blog/web/index1.php'" ?> ><img src="images/download (1).png" width="150" height="150"></a> <U>TRVEL BLOGS</U></h1><br>
...
<H1>
<a href=<?php echo "'../../../Image upload/upload1.php'" ?> ><img src="images/images.jpg" width="150" height="150"></a><U>IMAGE GALLERY</U></H1>
<?php 
include "dbconn.php";
