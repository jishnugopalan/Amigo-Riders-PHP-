		...
		<!-- menu -->
			...
			<div id="m_nav_container" class="m_nav">
			  <ul id="m_nav_list" class="m_nav">
				...
				<?php 
				 //echo "<li><br><a href='../blog/web/index2.php'>Blog</a><br></li>";
				 echo "<li><br><a href='../../../event/web/index.html'>Event</a><br></li>";	
...
<h1 id="c2"></h1>
<h1>
	<a href=<?php echo "'../../../blog/web/index2.php'" ?> ><img src="images/download (1).png" width="150" height="150"></a> <U>TRVEL BLOGS</U></h1><br>
				</div>
				<?php
...
<H1>
<a href=<?php echo "'../../../Image upload/upload2.php'" ?> ><img src="images/images.jpg" width="150" height="150"></a><U>IMAGE GALLERY</U></H1>
<?php 
include "dbconn.php";
...
<h1>
 ...
 <a href=<?php echo "'../../../Upload Video/index2.php'" ?> ><img src="images/download.png" width="150" height="150"></a> <U>VIDEO GALLERY</U></h1><br>
