			...
			<div class="sap_tabs">	
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
					<ul>
						...
						<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Who is your best friend &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span></li>
					...
					<div class="agile-tb">
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<form action="forgot1.php" method="post">				
								...
								<input placeholder="Type your answer" name="ans3" type="text" required="" autocomplete="off">						
								...
								<!--span class="checkbox1">
                                 ...
                                 <a href='../index.php'><font color="yellow">Home</font></a>&nbsp&nbsp&nbsp
                                  <!-- <a href='index3'><font color="white">Tell another question</font></a> -->
                                
								<input type="submit" name="ques3" value="Submit"/>
							</form>
						</div>	
