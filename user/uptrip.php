...
if(mysqli_query($conn,$sql1))
{
     ...
     $sql4="INSERT INTO notification(email,header,body,ndate,type,item_id,ntype,nname)values('$cemail','$cname','A new user joined in your trip to',NOW(),'2','$rid','tjoin','$d')";
