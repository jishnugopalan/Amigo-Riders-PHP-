...
<body>
	...
	<?php
include "dbconn.php";
$sql="SELECT * FROM event a,club_reg b where a.email=b.email and a.admin_s='y' order by a.event_id DESC";
							...
							<div class="col-md-8 w3ls-blog-left">
								<div class="w3-blog-left-grid">
									...
									<div class="w3ls-blog-leftr">
										...
										<h3>Event name:<?php echo $eventname ?></h3>
										<h3>Event type:<?php echo $type ?></h3>
										<h3>Event date:<?php echo $edate ?></h3>
										<h3>Event time:<?php echo $etime ?></h3>
										<h3>Event place:<?php echo $place ?></h3>
										<h3>No of persons can participate:<?php echo $no ?></h3>
										<h3>Description<p><?php echo $description ?></p></h3>
										<h3>Event booking Fee:<?php echo $bfee ?></h3>
										<h3>Event prize:<?php echo $price ?></h3>
										Email:<?php echo $email ?>

										<!--a href="single.html"><img src="images/10.jpg" alt=" " class="img-responsive" /></a-->
										<p></p>
										<ul>
											<li><input type="radio" value="<?php echo $bid ?>" data-id="<?php echo $bid ?>"  name="<?php echo $bid ?>">like</li>
											<li><input type="radio" value="<?php echo $bid ?>" data-id="<?php echo $bid ?>"  name="<?php echo $bid ?>">dislike</li>
											<li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i> 0 Tags</a></li>
											<li><a href="#"><i class="fa fa-comments" aria-hidden="true"></i> Join Now</a></li>
										</ul>
										<!--div class="more">
