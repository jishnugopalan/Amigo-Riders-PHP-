...
<div class="container">
	...
	<p>It is a platfom for express your feelings and activities.Here you can upload videos and images about your blogs.The blogs will be displayed for all riders.The riders can like and commend a blog.You cand edit your blog after uploading.You can also delete unnecessory commends from your blogs.The uploading images and videos will be displayed in your gallery.</p>
</div>
<div class="container">
	<h3>Trips</h3>
	<img class="card-img-top imgcard" src="images/tripjoin.jpeg" alt="Card image cap">
	<p>These trips are created by expert riders and also approved by admin.So you can join on any trips.For more information you can chat with riders.Only varified trips are displayed for you.
	</p></div>
	<div class="container">
		<h3>Buy Bikes</h3>
		<img class="card-img-top imgcard" src="images/buybikes.jpg" alt="Card image cap">
		<p>These bikes are sell by expert riders and also approved by admin.Here you can see the photos of bike and its ID proofs.There is a fixed price for bikes given by the seller.There is a platform for chat with these sellers and you can make a better deal with them.</p></div>


<div class="container">
	<h3>Club Updates</h3>
	<img class="card-img-top imgcard" src="images/clubupdates.png" alt="Card image cap">
	<p>Here you can see the blogs of different bike riding clubs.You can like and commend these blogs.The blogs contain introduction of new bikes and their events.So you can track all activites of clubs.
	</p></div>
