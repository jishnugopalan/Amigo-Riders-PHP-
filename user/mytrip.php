...
<br><br><br><br>
			...
			<center>
				<?php
$id=$_SESSION["email"];
$sql="SELECT * FROM tripjoin a,trip b where a.email='$id' and a.trip_id=b.trip_id and b.admin_s='y'";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result) >0)
{
	
?>
<label for="sel1">Select a destination:</label>
				 <select name="trip" id="sel1" class="form-control" onChange="getResult(this.value);">
<option value disabled selected>Select Destination</option>
<?php
foreach($result as $trip) {
?>
<option value="<?php echo $trip["trip_id"]; ?>"><?php echo strtoupper($trip["destination"]); ?></option>
<?php
}
...
echo "<h3>Please join to a trip</h3>";
