...
function validateForm()
{
 ...
 if (x.value.length<2)
  ...
  document.getElementById('pointfn').innerHTML="*Please enter a valid name.";
    x.focus();
  return false;
   }
...
/*else if ((!namepattern.test(x.value)))
   {
 alert("Please enter a valid date name.");
    x.value="";
  x.focus();
  return false;
   }*/
document.getElementById('dob').innerHTML='';
 ...
 if(x.value.length<2)
  ...
  return false;
   ...
   {
  x.value="";
 alert("Please enter the steet name which is less than 45 characters.");
  x.focus();
  return false;
 }
 ...
 if(x.value.length<0)
  ...
  return false;
   ...
   {
  x.value="";
 alert("Please enter the district which is less than 45 characters.");
  x.focus();
  return false;
 }
 ...
 if(x.value.length<2)
  ...
  return false;
   ...
   {
  x.value="";
 alert("Please enter the state which is less than 45 characters.");
  x.focus();
  return false;
 }
 ...
 if(x.value.length<2)
  ...
  return false;
   ...
   {
  x.value="";
 alert("Please enter the country which is less than 45 characters.");
  x.focus();
  return false;
 }*/
...
var x=document.forms["form1"]["ans1"];
 if (x.value.length<2)
   {
...
var x=document.forms["form1"]["ans2"];
 if (x.value.length<2)
   {
...
var x=document.forms["form1"]["ans3"];
 if (x.value.length<2)
   {
...
alert("Please enter a valid answer.");
 ...
 {
  alert("Plaese select a valid date.");
  return false;
 }
...
var FooPicker = (function () {
  ...
  var Calendar = {
    ...
    buildYears: function() {
      ...
      var year = this.year();
      for (var i = year - 80; i <= currentYear; i++) {
        elem += '<option value="' + i + '"';
        if (i === year) {
          elem += ' selected';
        }
