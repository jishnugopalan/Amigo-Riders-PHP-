							...
							<!-- <div class="col-md-8 w3ls-blog-left"> -->
								<div class="w3-blog-left-grid">
									...
									<!-- <div class="w3ls-blog-leftr"> -->
										<div class="h">
										<font color="white"><img class="p"  src="<?php echo  $photo; ?>" alt="" width="100" height="100"/>
										<?php echo $name ?> </font>
									</div>
									<br>
									 <div class="b">
										...
										<?php
                                         if($no!=0)
										 echo "No of persons can participate:",$no;
										 // else
										 // echo "Booking full"; 
										 ?><br>
										...
										<p></p>
											...
											if($z<=0)
											 ...
											 echo "<font color='red'>Sorry the event is alredy started</font>";
											 else
											 {	

												?>
											<a class="button" href="upevent.php?id=<?php echo $bid ?>&email=<?php echo $email ?>"><button class="btn btn-success"> Join Now</button></a>
											<?php
										}
										
									}
										else
											echo"<button class=''>Booking Full</button>";
