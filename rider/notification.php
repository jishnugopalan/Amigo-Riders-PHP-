...
if($ntype=='selling')
{
	...
	echo $header;
echo "<br>";
echo "Your bike with name ";
echo $nname;
echo " that you are created for selling was ";
echo $body;
echo"<br>";
echo date("d-m-Y H:m",$ndate);
echo"<br>";
	echo"<a href='selling.php'>See my sellings</a>";
	echo"<br>";
}
else if($ntype=='trip')
{
...
echo $nname;
echo " that you are created was ";
echo $body;
echo"<br>";
echo date("d-m-Y H:m",$ndate);
echo"<br>";
?>
	<a href="trip.php?sid=<?php echo $item_id ?>">See my trip</a>
	<?php
	echo"<br>";
}
else if($ntype=='tjoin')
...
echo date("d-m-Y H:m",$ndate);
echo"<br>";
	echo"<a href='mytrip.php'>See my squad</a>";
	echo"<br>";
}
else if($ntype=='djoin')
{
...
echo date("d-m-Y H:m",$ndate);
echo"<br>";
	echo"<a href='blog/blogs/blogupdate.php'>See my blogs</a>";
	echo"<br>";
}
else if($ntype=='blike')
	{
...
{ 
	...
	echo $header;
echo "<br>";
echo "The event with name ";
echo $nname;
echo" that you are joined ";
echo " was ";
echo $body;
echo"<br>";
echo date("d-m-Y H:m",$ndate);
echo"<br>";
echo"<a href='myevent.php'>See my events</a>";
	echo"<br>";
}
?>
</div><br><br>
